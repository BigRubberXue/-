<%@ Page Language="C#" AutoEventWireup="true" CodeFile="person_other.aspx.cs" Inherits="person_other" %>
                        ...
                        <nav class="navbar navbar-default" role="navigation">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                ...
                                <form class="navbar-form navbar-left" role="search">
                                    ...
                                    </div> <button  id="btn_search" type="submit" class="btn btn-default" onclick="btn_search">文章搜索</button>
                                </form>
    ...
    <div class ="row " >
        ...
        <div class ="col-md-1 ">
           ...
           <div class ="col-md-6 ">
               ...
               <asp:Button ID="Button1" class="btn btn-default glyphicon glyphicon-plus" style="background-color:gray ;color: rgb(255, 255, 255);font-size :28px" runat="server" Text="关注"  OnClick="attention_Click"/>
               <ul class="address">
            
            <li>
                    <ul class="address-text">
                        <li><b>昵称</b></li>
                    <li><asp:Label ID="Label1" runat="server" Text="Label" BorderColor="White" BorderStyle="None"></asp:Label>
                    </li>
                    </ul>
                </li>
                <li>
      ...
      <iframe src="./article_show.aspx?user_id=<%=article_user_id%>"  id="ifraMai2n" name="ifraMain2"  style="border:hidden;visibility:inherit; width:100%;z-index:100;"> </iframe>
    </form>
